        ...
        <div className="form-container">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-2 text-end">
              <NavLink to="/fpassword" type="button">
                Forgot Password?
              </NavLink>
            </div>
            <div className="mt-3">
        ...
        <div className="w-75">
          <div className="d-flex justify-content-around gap-3 align-items-center">
            <Feature
              ...
              text="Spreads has exciting features to connect with each other and share videos, music, audios, and more."
            />
            <Feature
              icon={<FiTrendingUp />}
              text="Explore trending charts, videos, audios, and reels."
            />
            <Feature
              icon={<TbBulb />}
              text="Explore thousands of learning programs, increase your knowledge, your potential with certification, and improve your skills."
            />
          </div>
          <div className="d-flex justify-content-around gap-3 p-4 align-items-center">
            <Feature
              icon={<BsSuitcaseLgFill />}
              text="Set your job alert on Spreads and grab your job opportunities."
            />
            <Feature
              icon={<BsBuildings />}
              text="Create a marketplace, stay updated with your product, and promote your brand."
            />
            <Feature
              icon={
              ...
              text="Use Spreads Business Solutions to solve your business problems, hire with us, and find your best solutions."
            />
          </div>
        </div>
      </div>
